 ...
 */
const users = [
  { name: "Maya", age: 19, major: "Informatics" },
  { name: "Kino", age: 24, major: "Dance" },
  { name: "Raga", age: 18, major: "Informatics" },
  { name: "Shita", age: 21, major: "Design" },
  { name: "Evan", age: 18, major: "Communication" }
];
...
const all = () => {
  for (let i of users) {
    console.log('Nama : ' + i.name);
    console.log('Umur : ' + i.age);
